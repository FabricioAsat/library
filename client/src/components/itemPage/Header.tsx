...
export const Header = ({
  ...
  return (
    <>
      ...
      {showDelete && (
        <aside className="fixed w-full h-auto px-4 py-5 -translate-x-1/2 -translate-y-1/2 bg-white border max-w-80 rounded-xl border-neutral-800 top-1/2 left-1/2 lg:top-0">
